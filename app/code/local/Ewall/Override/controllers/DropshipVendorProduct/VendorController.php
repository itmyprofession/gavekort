...
require_once "app/code/community/Unirgy/DropshipVendorProduct/controllers/VendorController.php";

class Ewall_Override_DropshipVendorProduct_VendorController extends Unirgy_DropshipVendorProduct_VendorController
{
    ...
    public function productPostAction()
    {
        ...
        if ($r->isPost()) {
            try {
                ...
                Mage::dispatchEvent('catalog_vendor_product_prepare_save', array('product' => $prod, 'request' => $this->getRequest()));
            } catch (Exception $e) {
