...
class Ewall_Override_Block_Adminhtml_Vendor_Edit_Tab_Preferences extends Unirgy_Dropship_Block_Adminhtml_Vendor_Edit_Tab_Preferences
{
    /**
	 *  Add additional fieldsets for vendors in the preferences section
	 *
	 */
