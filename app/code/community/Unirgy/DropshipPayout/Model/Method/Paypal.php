...
class Unirgy_DropshipPayout_Model_Method_Paypal implements Unirgy_DropshipPayout_Model_Method_Interface
{
    ...
    {
        return Mage::getConfig()->getModuleDir('etc', 'Unirgy_DropshipPayout').DS.'paypal'.DS.'PayPalSvc.wsdl';
    }
