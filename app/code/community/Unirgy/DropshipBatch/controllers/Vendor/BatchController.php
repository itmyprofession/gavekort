	...
	public function importStockPostAction()
    {
    	...
    	try {
	        ...
	        foreach ($rows as $i=>&$r) {
		        ...
		        if (!array_key_exists($skuPids[$r[$skuKey]], $this->_getSession()->getVendor()->getAssociatedProducts())) {
    		...
    		if (!empty($updateRequest)) {
	        	...
	        	if (($_multi = Mage::getConfig()->getNode('modules/Unirgy_DropshipMulti')) && $_multi->is('active')) {
